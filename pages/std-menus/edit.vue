...
<!--      <uni-forms-item name="parent_id" label="">
	  ...
	  <!-- <uni-forms-item name="parent_name" label="">
	    <uni-easyinput placeholder="父级菜单名称" v-model="formData.parent_id"></uni-easyinput>
	  </uni-forms-item>
 -->
  ...
  export default {
	...
	// 获取上传状态
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("menu_id,name,icon,link_url,sort,parent_id,permission,enable,create_date,menu_type,link_type").get().then((res) => {
